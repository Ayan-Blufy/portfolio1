...
const Box2 = ({img,data,name,stack,gitrepo,weblink}) => {
  return <div>
      <div class="flex flex-wrap items-center mb-6 sm:mb-32">
          <div class="w-full sm:w-3/5 mb-4 sm:mb-0">
              <img src={img} class="rounded shadow"/>
          </div>
          <div class="w-full sm:w-2/5">
              <div class="text-right mb-4">
                  <p class="text-theme-aquamarine text-sm font-poppins">Featured Project</p>
                  <h4 class="text-white text-2xl font-poppins font-extrabold">{name}</h4>
              </div>
              <div class="bg-theme-blue-base rounded p-6 shadow-xl ml-0 sm:-ml-16 mb-6">
              ...
              <div class="text-right">
                  <div class="flex justify-end mb-6">
                      {
                          stack.map((ele,i)=>{
                              return <span class="text-blue-200 text-xs mr-2" key={i}>{ele}</span>
                          })
                      }
                  ...
                  <div class="flex justify-end">
                      <a href={gitrepo} target="_blank" class="text-blue-100 hover:text-green-300 text-xs mr-5 h-6 w-6">
                      ...
                      <a href={weblink} target="_blank" class="text-blue-100 hover:text-green-300 text-xs h-6 w-6">
